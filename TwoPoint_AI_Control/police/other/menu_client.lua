...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateMenu('PIS:main', 'TwoPoint AI Control')
	...
	WarMenu.CreateSubMenu('PIS:rdo', 'PIS:main', 'Records')
    ...
    while true do
        if WarMenu.IsMenuOpened('PIS:main') then
			if WarMenu.MenuButton('Arrests (WIP)', 'PIS:arr') then
			elseif WarMenu.MenuButton('Interactions', 'PIS:int') then
			elseif WarMenu.MenuButton('Records', 'PIS:rdo') then
			elseif WarMenu.MenuButton('Weapons', 'PIS:wep') then
			elseif WarMenu.MenuButton('Other', 'PIS:misc') then
        ...
        elseif WarMenu.IsMenuOpened('PIS:misc') then
            ...
            WarMenu.Display()
        elseif TwoPoint_IsPlayerLEO and TwoPoint_IsPlayerLEO() and IsDisabledControlPressed(1, modifier) and IsDisabledControlJustPressed(1, mainmnu) then
...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateMenu('PIS:call:mnu', 'TwoPoint Callouts (WIP)')
...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateMenu('PIS:call', 'TwoPoint Callout Menu')
